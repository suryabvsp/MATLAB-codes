%Question 2: Plot the magnitude and phase spectra with T0 = 8 and Ts = 1/32 and compare with previous result
...
title('14UEC109, Question 2: Magnitude spectra') %Title for plot
...
title('14UEC109, Question 2: Phase spectra')     %Title for plot
